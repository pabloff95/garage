...
class ServiceCard extends React.Component {
  ...
  render() {
    return (
      <div className="animate-on-scroll mx-auto w-5/6 md:w-full min-w-[250px] border border-b-4 border-b-primary-element shadow-neutral-color-gray p-4 rounded-lg flex flex-col-reverse md:flex-row">
